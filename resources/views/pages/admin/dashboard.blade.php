                            ...
                            <div class="row align-items-center">
                                <div class="col-xl-8 col-xxl-12">
                                    <div class="text-xl-start text-xxl-center mb-4 mb-xl-0 mb-xxl-4">
                                        ...
                                        <p class="text-gray-700 mb-0">Di Website Manajemen Kegiatan Mahasiswa</p>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-xxl-12 text-center"><img class="img-fluid"
                                        src="/admin/assets/img/illustrations/img-app-surat.png" style="max-width: 15rem"
                                        alt="LOGO SURAT IAHN" /></div>
                            </div>
                        </div>
                    </div>
                </div>
