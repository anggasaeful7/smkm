                    ...
                    <table border="1" width="100%">
                        <tbody>
                            <tr>
                                <td valign="top">
                                    <div align="center">
                                        <span style="font-size: x-small;">&emsp;&emsp;&emsp;&emsp;<img
                                                src="/admin/assets/img/sttb.png" style="max-width: 7rem;"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td width="100%"><span style="font-size: x-small;">
                                                        <h6>KEMENTERIAN AGAMA REPUBLIK INDONESIA <br>INSTITUT AGAMA
                                                            HINDU GDE PUDJA MATARAM</h6>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="100%"><span style="font-size: x-small;">
