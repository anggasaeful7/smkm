    ...
    <table align="center" border="0" cellpadding="1" style="width: 700px;" class="table-bordered">
        <tbody>
            <tr>
                <td valign="top">
                    <div align="center">
                        <span style="font-size: x-small;"><img src="/admin/assets/img/sttb.png" style="max-width: 7rem;" alt="Gambar iahn"></span>
                    </div>
                </td>
                <td colspan="2">
            ...
            <tr>
                <td colspan="2" valign="top">
                    <table border="0" cellpadding="1" style="width: 400px;">
                        <tbody>
                            <tr valign="top">
                                <td width="400"><span style="font-size: x-small;">&emsp;<U>Disposisi Ketua Sekolah Tinggi Teknologi Bandung :</U> </span></td>
                            </tr>
                        </tbody>
                    </table>
                    <table border="0" cellpadding="1" style="width: 400px;">
