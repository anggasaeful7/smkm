        ...
        <div class="container-fluid px-4">
            <div class="row gx-4">
                <div class="col-lg-7">
                                ...
                                <table class="table">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>{{ Carbon\Carbon::parse($item->tanggal_pelaksanaan)->translatedFormat('l, d F Y') }}
                                            </td>
                                        </tr>
                                        <tr>
                    ...
                    <form action="{{ route('pendaftaran-kegiatan-umum') }}" method="post">
                        @csrf
                        <input type="hidden" name="daftarkegiatan_id" value="{{ $item->id }}">
                        <input type="hidden" name="user_id" value="{{ auth()->user()->id }}"> 
                        <input type="hidden" name="department_id" value="{{ $item->department_id }}">
                        <input type="hidden" name="jeniskegiatan_id" value="{{ $item->jeniskegiatan_id }}">
                ...
                <div class="col-lg-5">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                <img src="{{ Storage::url( $item->letter_file) }}" alt="Gambar">
