                ...
                <div class="row align-items-center justify-content-between pt-3">
                    <div class="col-auto mb-3">
                        <h1 class="page-header-title text-white">
                            <div class="page-header-icon text-white"><i class="fas fa-graduation-cap"></i></div>
                            Program Studi
                        </h1>
                    </div>
                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h5 class="modal-title text-white" id="createModal">Tambah Program Studi</h5>
            ...
            <form action="{{ route('prodi.store') }}" method="post">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <div class="col-md-12">
                            <label for="post_id">Jenis Program Studi</label>
                            <input type="text" name="name" class="form-control" placeholder="Masukan Nama Program Studi.." required>
                        </div>
                    </div>
                </div>
            ...
            <form action="{{ route('prodi.update', $item->id) }}" method="post">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <div class="col-md-12">
                            <label for="post_id">Jenis Program Studi</label>
                            <input type="text" name="name" value="{{ $name; }}" class="form-control" placeholder="Masukan Program Studi.." required>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
