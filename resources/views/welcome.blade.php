...
<head>
    <meta charset="utf-8">
    <title>SMKM STTB</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="description" content="Bootstrap App Landing Template">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=5.0">
    <meta name="author" content="IAHN SURAT">
    <meta name="generator" content="IAHN SURAT">
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{ url('/admin/images/favicon.png') }}" />
    <!-- PLUGINS CSS STYLE -->
    <link rel="stylesheet" href="{{ url('/admin/plugins/bootstrap/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ url('/admin/plugins/themify-icons/themify-icons.css') }}">
    <link rel="stylesheet" href="{{ url('/admin/plugins/slick/slick.css') }}">
    <link rel="stylesheet" href="{{ url('/admin/plugins/slick/slick-theme.css') }}">
    <link rel="stylesheet" href="{{ url('/admin/plugins/fancybox/jquery.fancybox.min.css') }}">
    <link rel="stylesheet" href="{{ url('/admin/plugins/aos/aos.css') }}">
...
<body class="body-wrapper" data-spy="scroll" data-target=".privacy-nav">
    <nav class="navbar main-nav navbar-expand-lg px-2 px-sm-0 py-2 py-lg-0">
        <div class="container">
            <a class="navbar-brand"><img src="{{ url('/admin/assets/img/sttb.png') }}" alt="IAHN" style="max-width: 3rem;margin-left: 5px;"><b>&nbsp; SMKM STTB </b></a>
            ...
            <div class="row align-items-center">
                <div class="col-md-6 order-2 order-md-1 text-center text-md-left">
                    ...
                    <p class="text-white mb-5">Besides its beautiful design. Laapp is an incredibly rich core framework for you to
                        showcase your App.</p>
                    <a href="{{ url('/logins') }}" class="btn btn-main-md">Login Now</a>
                </div>
                <div class="col-md-6 text-center order-1 order-md-2">
                    <img class="img-fluid" src="{{ url('/admin/images/img-app-surat.png') }}" alt="screenshot">
                </div>
            </div>
        </div>
    </section>
...
=============================-->
    ...
    <script src="{{ url('/admin/plugins/bootstrap/bootstrap.min.js') }}"></script>
    <script src="{{ url('/admin/plugins/slick/slick.min.js') }}"></script>
    <script src="{{ url('/admin/plugins/fancybox/jquery.fancybox.min.js') }}"></script>
    <script src="{{ url('/admin/plugins/syotimer/jquery.syotimer.min.js') }}"></script>
    <script src="{{ url('/admin/plugins/aos/aos.js') }}"></script>
    <!-- google map -->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAgeuuDfRlweIs7D6uo4wdIHVvJ0LonQ6g"></script>
    <script src="{{ url('/admin/plugins/google-map/gmap.js') }}"></script>
